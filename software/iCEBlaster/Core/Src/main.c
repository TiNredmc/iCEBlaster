 ...
 * Coded by TinLethax
 * https://github.com/TiNredmc/iCEBlasterb
 */
...
int main(void)
{
  ...
  HAL_GPIO_WritePin(USB_EN_GPIO_Port, USB_EN_Pin, 1);// Enable USB pull up to enumerate USB. By release open drain output
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LED_STAT_Pin|USB_EN_Pin|SPI1_CE_Pin, GPIO_PIN_RESET);
